...
import com.aegis.adhdtracker.ui.history.HistoryViewModel_HiltModules;
import com.aegis.adhdtracker.ui.logging.LogViewModel_HiltModules;
import com.aegis.adhdtracker.worker.MorningReadinessWorker_HiltModule;
import dagger.Binds;
...
public final class ADHDTrackerApp_HiltComponents {
  private ADHDTrackerApp_HiltComponents() {
  }
  ...
  @Component(
      modules = {
          ...
          MorningReadinessWorker_HiltModule.class
      }
  )
  @Singleton
  public abstract static class SingletonC implements ADHDTrackerApp_GeneratedInjector,
